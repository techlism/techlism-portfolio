...
const ProjectCard = (props) =>{
    return(
        <div className={styling.ProjectCardMain}>
                    <img src={props.source} alt={`${props.source} Project`} className={styling.projectPreview}/>
                    <div className={styling.headingDescription}>
                        <h1>{props.title}</h1>
                        <p>{props.description}</p>
                    </div>
                    <div className={styling.links}>
                        <a href={props.deployed} target='blank'><img src={internetLogoLocation} alt="click to open deployed version" /></a>
                        <a href={props.github} target='blank'><img src={codeLogoLocation} alt="click to see source code" /></a>
                    </div>
